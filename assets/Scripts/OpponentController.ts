...
export default class NewClass extends cc.Component {
    ...
    @property
        OpponentMoveY:number = 25;
    OpponentMoveAction:cc.ActionInterval;
    @property(cc.Prefab)
        OpponentWeapon:cc.Prefab  = null;
    @property
        OpponentWeaponFrequency:number = 2.5;
    OpponentLife:number = 2;
    OpponentAnimation:boolean = true;

    // LIFE-CYCLE CALLBACKS:

    OpponentMove(){
        var OpponentMoveLeft = cc.moveBy(this.OpponentDuration,cc.v2(-this.OpponentMoveX,-this.OpponentMoveY))/*.easing(cc.easeCircleActionInOut())*/;
        var OpponentMoveRight = cc.moveBy(this.OpponentDuration,cc.v2(this.OpponentMoveX,-this.OpponentMoveY))/*.easing(cc.easeCircleActionInOut())*/;
    ...
    onLoad () {
        ...
        this.schedule(this.spawnBullets,this.OpponentWeaponFrequency,cc.macro.REPEAT_FOREVER,2.0);
    }
